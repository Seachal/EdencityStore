...
#CircleImageView
-dontwarn com.hdodenhof.circleimageview.**
-keep class com.hdodenhof.circleimageview.** {*;}

#paho
-dontwarn org.eclipse.paho.client.mqttv3.**
-keep class org.eclipse.paho.client.mqttv3.** { *; }

-dontwarn org.eclipse.paho.android.**
...
-keep class cn.zhongyu.edencity.entity.**{*;} # 自定义数据模型的bean目录
# RxJava RxAndroid
-dontwarn sun.misc.**
