...
public class BaseDebug {
 ...
 public BaseDebug(String title, boolean checked) {
        this.title = title;
        this.checked = checked;
    }
    ...
    public BaseDebug(String title, String subtitle, boolean checked, int resource) {
        this.title = title;
        this.checked = checked;
        this.resource = resource;
        this.subtitle = subtitle;
    ...
    public BaseDebug(String title, String subtitle, int resource, String date, boolean checked, String url) {
        this.title = title;
        this.checked = checked;
        this.resource = resource;
        this.subtitle = subtitle;
