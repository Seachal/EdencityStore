...
/**
 * Created by Ardy on 2018/8/13.
 */
public class DeeSpUtil {

  private static DeeSpUtil                prefsUtil;
  public         Context                  context;
  public         SharedPreferences        prefs;
  public         SharedPreferences.Editor editor;

  public synchronized static DeeSpUtil getInstance() {
    return prefsUtil;
  }

  public static void init(Context context, String prefsname, int mode) {
    prefsUtil = new DeeSpUtil();
  ...
  @TargetApi(Build.VERSION_CODES.HONEYCOMB) public Set<String> getStringSet(String key) {
  ...
  public DeeSpUtil putString(String key, String value) {
    editor.putString(key, value);
    editor.commit();
    return this;
  }

  public DeeSpUtil putInt(String key, int value) {
    editor.putInt(key, value);
    editor.commit();
    return this;
  }

  public DeeSpUtil putFloat(String key, float value) {
    editor.putFloat(key, value);
    editor.commit();
    return this;
  }

  public DeeSpUtil putLong(String key, long value) {
    editor.putLong(key, value);
    editor.commit();
    return this;
  }

  public DeeSpUtil putBoolean(String key, boolean value) {
  ...
  @TargetApi(Build.VERSION_CODES.HONEYCOMB)
  public DeeSpUtil putStringSet(String key, Set<String> value) {
  ...
  public DeeSpUtil remove(String key) {
    editor.remove(key);
    editor.commit();
    return this;
  }
