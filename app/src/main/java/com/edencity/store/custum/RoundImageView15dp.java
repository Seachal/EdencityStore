...
public class RoundImageView15dp extends AppCompatImageView {
    private Context mContext;
    float width,height;
    private int mRadiusPx;

    public RoundImageView15dp(Context context) {
        this(context, null);
    }

    public RoundImageView15dp(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundImageView15dp(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        mRadiusPx = DensityUtil.dp2px(15);
