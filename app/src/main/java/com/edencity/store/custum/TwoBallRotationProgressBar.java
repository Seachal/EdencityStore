...
public class TwoBallRotationProgressBar extends View {
    ...
    //默认小球最大半径
    private final static int DEFAULT_MAX_RADIUS = 20;
    //默认小球最小半径
    private final static int DEFAULT_MIN_RADIUS = 10;
    //默认两个小球运行轨迹直径距离
    private final static int DEFAULT_DISTANCE = 30;

    //默认第一个小球颜色
    private final static int DEFAULT_ONE_BALL_COLOR = Color.parseColor("#43E1EC");
    //默认第二个小球颜色
    private final static int DEFAULT_TWO_BALL_COLOR = Color.parseColor("#1436EC");
