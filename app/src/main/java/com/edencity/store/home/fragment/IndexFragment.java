...
import com.edencity.store.user.fragment.UserFragment;
...
public class IndexFragment extends BaseFragment2 {
    ...
    @BindView(R.id.frag)
    FrameLayout mFrag;
   /* @BindView(R.id.radiobutton_check)
    ImageView mCheck;*/
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    case R.id.radiobutton_firstpage:
                        addFragment(manager, HomeFragment.class, R.id.frag, null);
                       ...
                       /* radio_first.setVisibility(View.GONE);
                        *//*mCheck.setVisibility(View.VISIBLE);*/
                        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
                        window.setStatusBarColor(Color.TRANSPARENT);
                        break;
                    case R.id.radiobutton_notification:
                        /*radio_first.setVisibility(View.VISIBLE);
                        mCheck.setVisibility(View.GONE);*/
                        addFragment(manager, VipFragment.class, R.id.frag, null);
                    ...
                    case R.id.radiobutton_shopcart:
                      /*  radio_first.setVisibility(View.VISIBLE);
                        ...
                        case R.id.radiobutton_msg:
                          /*  radio_first.setVisibility(View.VISIBLE);
                            mCheck.setVisibility(View.GONE);*/
                            addFragment(manager,NotificationFragment.class,R.id.frag,null);
                            StatusBarCompat.changeToLightStatusBar(getActivity());
                        break;
