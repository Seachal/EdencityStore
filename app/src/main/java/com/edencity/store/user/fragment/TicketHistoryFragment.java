 ...
 */
public class TicketHistoryFragment extends BaseFragment2 {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_ticket_history, container, false);
        initView(inflate);
        initLogic();
        return inflate;
    }
    private void initLogic() {
        ...
        for (int i = 0; i < 2; i++) {
            ItemTicketHistoryFragment myCertFragment = new ItemTicketHistoryFragment ();
