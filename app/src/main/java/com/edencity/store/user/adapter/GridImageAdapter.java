...
public class GridImageAdapter extends
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener, int Rid) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            if (RId != 0) {
                viewHolder.mImg.setImageResource(RId);
            } else {
            ...
            viewHolder.mImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //
                    if (mItemTagClickListener != null) {
                        mItemTagClickListener.onItemClick();
                    }
                }
            });
           ...
           /* viewHolder.tv_duration.setVisibility(pictureType == PictureConfig.TYPE_VIDEO
            ...
            /*viewHolder.tv_duration.setText(com.luck.picture.lib.tools.DateUtils.timeParse(duration));*/
            if (mimeType == PictureMimeType.ofAudio()) {
    ...
    protected OnItemTagClickListener mItemTagClickListener;
    ...
    public void setOnItemTagClickListener(OnItemTagClickListener listener) {
        this.mItemTagClickListener = listener;
    }
